...
func (s Store) Update(ctx context.Context, userID string, uu UpdateUser, now time.Time) error {
	...
	// Here I'm querying the user before updating it,
	// this allows me to avoid putting together transactions.
	// This also means that If someone else updated the same data
	// during the processing of this request, the update is going to be
	// overridden.
